...
filename = "unique_results/filtered_mirtax_in_titel_abstract.txt"
unique_tax = {}
...
with open('unique_results/filtered_tax_noCount.txt', 'w', encoding="utf-8") as f:
...
filename = "unique_results/filtered_tax_noCount.txt"
f = open(filename, encoding="utf-8")
lines = f.readlines()
for line in lines:
    line = line.strip("\n")
...
with open('unique_results/filtered_tax_percentage.txt', 'w', encoding="utf-8") as f:
