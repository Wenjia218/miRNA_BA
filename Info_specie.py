...
plant_mir = {}
with open('myresults/plant_mir.txt', 'r') as f:
    lines = f.readlines()
    for line in lines:
        list = line.split(": ")
        plant = list[0]
...
miR_list = plant_mir["Daucus carota"].split(",")
paper_list = plant_papers["Daucus carota"].split(",")
counts = {}
...
with open('myresults/carrot.txt', 'w', encoding="utf-8") as f:
        f.write("Daucus carota")
        f.write(": " + "\n")
        ...
        f.write("\n")
        f.write(plant_mir["Daucus carota"])
        f.write('\n')
        f.write(plant_papers["Daucus carota"])