...
FORM_positions = {}
PMC_lines = {}
with open('textmining_resutls/unique_mir_withallwords.txt', 'r') as f:
    lines = f.readlines()
    for line in lines:
        PMC = line.split(" ")[0]
        PMC_lines[PMC] = line
...
with open('textmining_resutls/unique_mir_count_bigger_than_3', 'w') as f:
...
with open('textmining_resutls/unique_mir_in_topic_or_abstract', 'w') as f:
